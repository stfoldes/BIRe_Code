...
function MRI_Info = fMRI_RunFunctionalAnalysis_MNI(MRI_Info)
...
% List of open inputs
jobfile = {which('Final_Script_MNI_job.m')};
...
for ifile = 1:length(run_name_list)
    ...
    if isempty(regexp(MRI_Info.file4spm_processing,'MPRAGE')) % Don't do for MPRAGE
        ...
        disp(' ')
        disp('**************************************************************')
        disp(['***' MRI_Info.file4spm_processing ' @fMRI_RunFunctionalAnalysis_MNI***'])
        disp('**************************************************************')
        ...
        if exist_path == 7
            try
                ...
                if exist([MRI_Info.study_path '/FunctionalData_MNI'],'dir')~=7
                    mkdir([MRI_Info.study_path '/FunctionalData_MNI'])
                end
                copyfile([current_file_path '/spmT_0001.hdr'], ...
                    [MRI_Info.study_path '/FunctionalData_MNI/fMRI_' ...
                    MRI_Info.file4spm_processing(5:end) '.hdr'])
                copyfile([current_file_path '/spmT_0001.img'], ...
                    [MRI_Info.study_path '/FunctionalData_MNI/fMRI_' ...
                ...
                copyfile([current_file_path '/spmT_0001.hdr'], ...
                    [MRI_Info.study_path '/FunctionalData_MNI/fMRI_suma_' ...
                    MRI_Info.file4spm_processing(5:end) '.hdr']);
                copyfile([current_file_path '/spmT_0001.img'], ...
                    [MRI_Info.study_path '/FunctionalData_MNI/fMRI_suma_' ...
                    MRI_Info.file4spm_processing(5:end) '.img']);
