function ButtonName=questdlg_wPosition(Pos,Question,Title,Btn1,Btn2,Btn3,Default)
% answer=questdlg_wPosition([],'Calculate and perform SSP?','SSP?','Yes','Skip','Yes');
%
...
%
% UPDATES
% 2013-01-30 FOLDES: Will use default figure position if Pos input is empty or 0
...
if isempty(Pos) || max(size(Pos))<2 % 2013-01-30 FOLDES
