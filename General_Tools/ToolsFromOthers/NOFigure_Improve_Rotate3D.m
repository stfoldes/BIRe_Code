classdef Figure_Improve_Rotate3D < handle
...
% drawnow();
% f = Figure_Improve_Rotate3D(gca);
%
% The Figure_Improve_Rotate3D can later be stopped by calling the Stop() function.
%
% f.Stop();
%
...
% the constructor.
%
% f = Figure_Improve_Rotate3D(gca, 'CameraTarget',    [0 0 0], ...
%                        'CameraPosition',  [15 0 0], ...
%                        'CameraUpVector',  [0 0 1], ...
%                        'CameraViewAngle', 60);
%
% The Figure_Improve_Rotate3D allows complete 3D rotation, so if you start losing
...
% Figure_Improve_Rotate3D, which will pass all arguments on to the provided callback
% function.
%
% Example:
%
...
%
% A single Figure_Improve_Rotate3D can control multiple axes, even axes across
% multiple figures.
%
% Example:
% 
...
% ha3 = gca();
% 
% f = Figure_Improve_Rotate3D([ha1 ha2 ha3]);
%
% Tucker McClure
% Copyright 2012, The MathWorks, Inc.
%
% 2014-01-28 Foldes: Renamed from FigureRotator.m, Doesn't need handle input
    ...
    methods
        ...
        % Construct a Figure_Improve_Rotate3D for the given axes.
        function o = Figure_Improve_Rotate3D(axes_handle, varargin)
            
            % no handle, use gca 2014-01-27
            if ~exist('axes_handle') || isempty(axes_handle)
                axes_handle = gca;
            end
        ...
        % Figure_Improve_Rotate3D hogs to itself. This way, a user can still get all
