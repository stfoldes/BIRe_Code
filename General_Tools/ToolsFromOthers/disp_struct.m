function disp_struct(A)
% Displays the contense of a structure or object (or anything) in a window
...
% Format variable
if isstruct(A) || isobject(A) % 2014-02-07
...
function strA = FormatValue(A, isCode, nIndent)
    ...
    % STRUCTURES
    elseif isstruct(A) || isobject(A) % 2014-02-07
